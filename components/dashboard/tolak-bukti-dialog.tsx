    ...
    <form onSubmit={handleSubmit} className="space-y-3.5 pt-1">
        ...
        <div className="flex flex-wrap gap-1.5">
          {TEMPLATE_ALASAN.map((tpl, idx) => (
            <button
              ...
              className="text-xs px-2.5 py-1 rounded-md border border-zinc-200 bg-white hover:bg-zinc-100 hover:border-zinc-300 hover:text-zinc-950 transition-colors text-zinc-700 text-left cursor-pointer"
            >
              {tpl}
            </button>
          ))}
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-zinc-500 leading-relaxed">
          Catatan ini akan tampil di layar tagihan Penghuni beserta opsi unggah ulang bukti transfer.
        </p>
      </div>
