...
- [ ] **Step 1: Periksa status pengujian awal pada login dan dashboard**
  Run: `pnpm test tests/login-page.test.tsx tests/dashboard-page.test.tsx`
  Expected: PASS

- [ ] **Step 2: Perbarui spacing & padding pada `app/login/page.tsx`**
...
- [ ] **Step 3: Perbarui spacing & padding pada `app/dashboard/page.tsx`**
...
- [ ] **Step 4: Perbarui spacing & touch target pada `components/dashboard/dashboard-header.tsx`**
...
- [ ] **Step 5: Jalankan pengujian verifikasi Task 1**
  Run: `pnpm test tests/login-page.test.tsx tests/dashboard-page.test.tsx`
  Expected: PASS
...
- [ ] **Step 3: Perbarui spacing pada `pemilik-summary-cards.tsx`**
...
- [ ] **Step 4: Perbarui spacing pada `pemilik-verifikasi-antrean.tsx`**
...
- [ ] **Step 5: Perbarui spacing pada `pemilik-daftar-kamar.tsx`**
...
- [ ] **Step 6: Jalankan pengujian verifikasi Task 2**
  Run: `pnpm test tests/pemilik-ringkasan.test.tsx tests/pemilik-verifikasi.test.tsx tests/kelola-tagihan.test.tsx`
  Expected: PASS
...
- [ ] **Step 4: Perbarui spacing pada `penghuni-riwayat-pembayaran.tsx`**
  - Card: `CardHeader className="p-5 pb-3.5"`, `CardContent className="p-5 pt-0 space-y-3"`
  - Item riwayat: `p-3.5 sm:p-4 rounded-xl border border-slate-100 flex items-center justify-between gap-3`

- [ ] **Step 5: Perbarui spacing pada `pengaturan-profil-view.tsx`**
  - Wrapper: `space-y-6`
...
- [ ] **Step 6: Jalankan pengujian verifikasi Task 3**
  Run: `pnpm test tests/penghuni-tagihan.test.tsx tests/penghuni-riwayat.test.tsx tests/bottom-nav-reset.test.tsx`
  Expected: PASS
...
- [ ] **Step 3: Perbarui spacing pada seluruh dialog modal**
...
- [ ] **Step 4: Jalankan pengujian verifikasi Task 4 & Suite Lengkap**
  Run: `pnpm test`
  Expected: All 75 tests PASS

- [ ] **Step 5: Verifikasi Linting dan Build Produksi**
  Run: `pnpm run lint`
